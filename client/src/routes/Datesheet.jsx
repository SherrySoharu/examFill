import { Button, Paper, Modal, Box, Typography, ImageList, ImageListItem } from "@material-ui/core";
    ...
    return (
        <div>
            ...
            {datesheet ? 
                    ...
                    </Paper> : (<Typography color="red">No datesheets uploaded yet</Typography>)}
        </div>
    )
}
